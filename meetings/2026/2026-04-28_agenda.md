...
* **Security Topics**
  ...
  * **Threat Model for The Web DFD**
    ...
    * TMW DFD: [Data Flow Diagram](https://github.com/w3c/threat-model-web)
    ...
    We should collect feedback on the current state of the DFD in the Threat Model for The Web Editor's Draft. Also, we should open a call for consensus on publishing the Threat Model for The Web as First Public Note Draft so that it can be referenced in the ETSI EN 304-617 vertical draft standard currently being drafted.
